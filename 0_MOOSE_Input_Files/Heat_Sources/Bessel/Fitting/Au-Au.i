...
[Materials]
    ...
    [First_Ring_Beam_Radius]
        ...
        property_name = rR1
        material_property_names = 'length_scale'
        expression = '35.0e-6*length_scale' 
    []
    ...
    [Second_Ring_Beam_Radius]
        ...
        property_name = rR2
        material_property_names = 'length_scale'
        expression = '43.0e-6*length_scale' 
    []
    ...
    [Second_ring_Beam_half_Thickness]
        ...
        property_name = rT2
        material_property_names = 'length_scale'
        expression = '3.0e-6*length_scale' 
    []

    [Third_Ring_Beam_Radius]
        type = ParsedMaterial
        property_name = rR3
        material_property_names = 'length_scale'
        expression = '48.0e-6*length_scale' 
    []

    [Third_ring_Beam_half_Thickness]
        type = ParsedMaterial
        property_name = rT3
        material_property_names = 'length_scale'
        expression = '2.0e-6*length_scale' 
    []
    ...
    [volumetric_heat]
        ...
        power = pow
        efficiency = 0.6
        gaussian_power_prop = 0.72
        first_ring_power_prop = 0.16
        second_ring_power_prop = 0.08
