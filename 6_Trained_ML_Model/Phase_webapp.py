...
if option == 0:
    ...
    if X_test_file:
        ...
        ax2.set_title('Phase Evolution (ML Prediction)', pad=80, loc='left', fontsize=25, weight='bold')
    ...
    observation = st.slider("Select Random Temporal Parameters", min_value=1, max_value=X_test_array.shape[0], value=53) - 1
